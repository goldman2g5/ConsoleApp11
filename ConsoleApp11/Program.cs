...
namespace Cosoleapp3
{
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var pistolShot = new Skill("pistolShot", damage: 0.85, targets: new List<int>() {1, 2 ,3}, usablefrom: new List<int>() {2, 3, 4});
            var duelistddvance = new Skill("Duelist's Advance", damage: 0.67, targets: new List<int>() {0, 1 ,2}, usablefrom: new List<int>() {1, 2, 3, 4}, moveself: 1, statusList: new List<Status>{Status.GetStatus("Riposte")}, buffself: true);
            ...
            var skeletonBannerLord = new Character("Skeleton Banner Lord", 28, 14, 0, 30, 0.75, 5, 10,
            ...
            var skeletonArcher = new Character("Skeleton Crossbowman", 35, 16, 0, 10, 0.20, 15, 4,
